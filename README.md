...
- [Advanced Options](#advanced-usage-and-options)
...
<!-- delaying the initialisation of an element within a normal alpine component until it's visible -->
<div x-data>
  <div
    ax-load="visible"
    x-ignore
